...
$LastChangedBy: manu $ $Revision: 93 $
$LastChangedDate: 2007-09-04 22:44:17 +0100 (Tue, 04 Sep 2007) $
...
static int      *Degree;     /* Number of links adjacent to each node  */
...
*/
static int      *XLNZ,       /* Start position of each column in NZSUB  */
