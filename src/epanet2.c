...
return EN_addleveltrigger(_defaultProject, pump_index, tank_index,
...
{
	return EN_getnumwarnings(_defaultProject);		
}
...
{
	return EN_getnode_xcoord(_defaultProject, index, x);
}

int DLLEXPORT ENgetnode_ycoord(int index, float *y)
{
	return EN_getnode_ycoord(_defaultProject, index, y);	
}